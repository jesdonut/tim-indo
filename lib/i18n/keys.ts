...
export const EN = {
  ...
  "pdf.reorderHint2": "Drag between pages to insert · blank / duplicate / rotate / delete on each page",
  "pdf.addBlank": "Insert blank page (same size)",
  "pdf.blank": "blank",
  "pdf.blankColor": "Blank page color",
  "pdf.pageColor": "Page color",
  "pdf.tabResize": "Resize",

  // Resize tab
  "resize.intro": "Rescale every page to a target paper size, keeping aspect ratio. Align or nudge the leftover mm, and set the page color.",
  "resize.target": "Target size",
  "resize.custom": "Custom",
  "resize.orient": "Match source orientation",
  "resize.fit": "Scale to fit",
  "resize.fitWidth": "Width",
  "resize.fitHeight": "Height",
  "resize.hAlign": "Horizontal",
  "resize.vAlign": "Vertical",
  "resize.nudge": "Nudge (mm)",
  "resize.white": "White",
  "resize.source": "Source",
  "resize.targetSize": "Target",
  "resize.scaled": "Scaled",
  "resize.leftover": "Leftover",
  "resize.previewNote": "The dashed frame is the target size; the image is the scaled page.",
  "resize.allPages": "All pages",
  "resize.page": "Page",
  "resize.resetPage": "Reset to all",
  "resize.perPage": "Custom for this page",
  "resize.binding": "Binding",
  "resize.bindOff": "Off",
  "resize.bindInner": "Gutter inner",
  "resize.bindOuter": "Gutter outer",
